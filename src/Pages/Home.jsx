...
const WORDS = ["Frontend Development ", "Web Development Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Material-UI", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/esonaliyev05" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/alyorbek-esonaliyev-9a6a27321/",
  },
  { icon: Instagram, link: "https://www.instagram.com/esonaliyev_alyorbek" },
];
...
const Home = () => {
  ...
  return (
    <div
      className="pt-12 sm:pt-9 lg:pt-10 xl:pt-0 bg-[#030014] overflow-hidden"
      id="Home"
    >
      <div
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] pt-12 sm:pt-9 lg:pt-10 xl:pt-0">
              ...
              <div className="relative w-full opacity-90">
                ...
                >
                  <img
                    src="/Coding.gif"
                    alt="Profile"
                    className="w-full max-w-[600px] h-full max-h-[530px] object-cover transition-all duration-700 group-hover:scale-110 group-hover:rotate-2"
                    loading="lazy"
                  />
                </div>
